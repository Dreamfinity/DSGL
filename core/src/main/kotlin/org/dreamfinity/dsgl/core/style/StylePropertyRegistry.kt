...
object StylePropertyRegistry {
    val all: List<StylePropertyDescriptor> =
        listOf(
            StylePropertyDescriptor(
                StyleProperty.DISPLAY,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("block", "inline", "none", "flex", "grid"),
            ),
            StylePropertyDescriptor(
            ...
            StylePropertyDescriptor(
                ...
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("normal", "bold"),
                isInherited = true,
            ),
            StylePropertyDescriptor(
                StyleProperty.FONT_STYLE,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("normal", "italic"),
                isInherited = true,
            ),
            StylePropertyDescriptor(
            ...
            StylePropertyDescriptor(
                StyleProperty.OBFUSCATED,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("false", "true"),
            ),
            StylePropertyDescriptor(
                StyleProperty.ALIGN,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("start", "center", "end"),
            ),
            StylePropertyDescriptor(
                StyleProperty.FLEX_DIRECTION,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("row", "column"),
            ),
            StylePropertyDescriptor(
            ...
            StylePropertyDescriptor(
                ...
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("start", "center", "end", "stretch"),
            ),
            StylePropertyDescriptor(
            ...
            StylePropertyDescriptor(
                StyleProperty.GRID_COLUMNS,
                StyleEditorValueType.IntNumber,
                numericStep = 1f,
                minInt = 1,
            ),
            StylePropertyDescriptor(
                StyleProperty.GRID_ROWS,
            ...
            StylePropertyDescriptor(
                StyleProperty.GRID_COLUMN_SPAN,
                StyleEditorValueType.IntNumber,
                numericStep = 1f,
                minInt = 1,
            ),
            StylePropertyDescriptor(
                StyleProperty.GRID_ROW_SPAN,
                StyleEditorValueType.IntNumber,
                numericStep = 1f,
                minInt = 1,
            ),
            StylePropertyDescriptor(
                ...
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("wrap", "nowrap"),
            ),
            StylePropertyDescriptor(
                StyleProperty.TEXT_FORMATTING,
                StyleEditorValueType.EnumChoice,
                enumOptions = listOf("none", "minecraft"),
            ),
            StylePropertyDescriptor(
                StyleProperty.TRANSFORM,
                StyleEditorValueType.StringPreset,
                enumOptions = listOf("none", "translate(12, 0)", "scale(1.2)", "rotate(15deg)"),
            ),
            StylePropertyDescriptor(
                StyleProperty.TRANSFORM_ORIGIN,
                StyleEditorValueType.StringPreset,
                enumOptions = listOf("0 0", "0.5 0.5", "1 1", "50% 50%"),
            ),
            StylePropertyDescriptor(
    ...
    fun descriptor(property: StyleProperty): StylePropertyDescriptor =
        byProperty[property] ?: error("Missing style descriptor for '${property.key}'.")
    ...
    fun parseEnumLiteral(property: StyleProperty, literal: String): String {
        ...
        val matched =
            descriptor.enumOptions.firstOrNull { it.equals(normalized, ignoreCase = true) }
