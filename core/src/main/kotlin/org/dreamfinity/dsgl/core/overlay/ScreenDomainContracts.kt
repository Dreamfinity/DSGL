...
object ScreenDomainSurfaces {
    ...
    fun portalSurfaceForOwner(ownerScope: OverlayOwnerScope): ScreenDomainSurface = portalSurface(ownerScope.domain)

    @Suppress("UnusedParameter")
    fun portalSurfaceForOwner(ownerScope: OverlayOwnerScope, cursorX: Int, cursorY: Int): ScreenDomainSurface =
        portalSurfaceForOwner(ownerScope)
...
val OverlayOwnerScope.domain: ScreenDomainId
    get() =
        when (this) {
            OverlayOwnerScope.Application -> ScreenDomainId.Application
            OverlayOwnerScope.System -> ScreenDomainId.System
        }
