...
open class SelectProps : ComponentProps() {
    ...
    var ownerDomain: ScreenDomainId = ScreenDomainId.Application
...
@DsglDsl
fun UiScope.input(type: InputType, props: InputProps.() -> Unit = {}, ref: RefTarget<ElementHandle>? = null) =
...
@DsglDsl
fun UiScope.textarea(props: TextAreaProps.() -> Unit = {}, ref: RefTarget<ElementHandle>? = null) =
...
@DsglDsl
fun UiScope.toggle(props: ToggleProps.() -> Unit = {}, ref: RefTarget<ElementHandle>? = null) =
