...
fun selectModel(id: String? = null, block: SelectModelBuilder.() -> Unit): SelectModel {
...
class SelectModelBuilder {
    ...
    fun option(id: String, label: String, block: SelectOptionBuilder.() -> Unit = {}) {
        option(id = id, labelProvider = { label }, block = block)
    }

    fun option(id: String, labelProvider: () -> String, block: SelectOptionBuilder.() -> Unit = {}) {
    ...
    fun group(label: String, id: String? = null, block: SelectGroupBuilder.() -> Unit) {
        group(labelProvider = { label }, id = id, block = block)
    }

    fun group(labelProvider: () -> String, id: String? = null, block: SelectGroupBuilder.() -> Unit) {
