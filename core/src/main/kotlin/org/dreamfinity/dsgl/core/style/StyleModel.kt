...
data class ComputedStyle(
    ...
    val minWidth: CssLength?,
    val minHeight: CssLength?,
    val maxWidth: CssLength?,
...
data class ComputedStyleDefaults(
    ...
    val overflowX: Overflow = Overflow.Visible,
    val overflowY: Overflow = Overflow.Visible,
