...
class PortalGeometryIntegrationTests {
    private val ctx =
    ...
    @Test
    fun `system portal root uses full game viewport bounds in live host path`() {
    ...
    @Test
    fun `reopen remembered popup position remains clamped for current portal viewport`() {
        val engine = ColorPickerPopupEngine()
