...
class InspectorInputPathBaselineTests {
    ...
    fun `inspector dropdown option selection is consumed without click through`() {
        ...
        DomainPortalServices.systemSelectEngine.handleMouseMove(optionX, optionY)
        assertTrue(DomainPortalServices.systemSelectEngine.handleMouseDown(optionX, optionY, MouseButton.LEFT))
        assertTrue(DomainPortalServices.systemSelectEngine.handleMouseUp(optionX, optionY, MouseButton.LEFT))
