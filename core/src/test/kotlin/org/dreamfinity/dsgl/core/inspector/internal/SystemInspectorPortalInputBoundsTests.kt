...
class SystemInspectorPortalInputBoundsTests {
    @Test
    fun `input bounds include rendered dropdown popup outside panel`() {
        ...
        val node = SystemInspectorPortalNode(controller)
        val panelRect = controller.floatingPanelRect() ?: error("expected panel rect")
