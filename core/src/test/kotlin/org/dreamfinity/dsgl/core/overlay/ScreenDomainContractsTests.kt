...
class ScreenDomainContractsTests {
    ...
    fun `owner scope resolves to compatible portal domain surfaces`() {
        assertEquals(
            ScreenDomainSurfaces.ApplicationPortal,
            ScreenDomainSurfaces.portalSurfaceForOwner(OverlayOwnerScope.Application),
        )
        assertEquals(
            ScreenDomainSurfaces.SystemPortal,
            ScreenDomainSurfaces.portalSurfaceForOwner(OverlayOwnerScope.System),
        )
    }
    ...
    fun `color picker popup defaults to application portal ownership`() {
        ...
        assertEquals(ScreenDomainSurfaces.ApplicationPortal, ColorPickerPopupOverlayOwnership.resolveSurface(request))
    }
    ...
    fun `system-owned color picker popup resolves to system portal`() {
        ...
        assertEquals(ScreenDomainSurfaces.SystemPortal, ColorPickerPopupOverlayOwnership.resolveSurface(request))
    }
}
