...
class InspectorTextEditingDomMigrationTests {
    ...
    private fun findVisibleInputNode(host: SystemPortalHost, inspector: InspectorController, keyPrefix: String): TextInputNode {
        val inspectorNode =
            host.debugEntryNode(SystemPortalEntryId.Inspector) ?: error("inspector entry missing")
    ...
    private fun focusInputByClick(host: SystemPortalHost, input: TextInputNode): Pair<Int, Int> {
