...
import org.dreamfinity.dsgl.mcForge1122.scissorsHelper.ScissorContext
import org.dreamfinity.dsgl.mcForge1122.text.MsdfTextRenderer
...
/**
 * Minecraft 1.12.2 adapter that turns DSGL render commands into Minecraft calls.
 */
class Mc1122UiAdapter(private val mc: Minecraft, var paintsCount: Long = 0L) : UiMeasureContext {
    ...
    private fun resolveImage(source: String): ResourceLocation? {
        ...
        return when {
            ...
            source.startsWith("file://") -> {
                ...
                val baseDir = File(mc.gameDir, "dsgl")
    ...
    private fun remoteFileFor(url: URL): File {
        ...
        path = path.replace("..", "_")
        val baseDir = File(mc.gameDir, "dsgl/cache/downloads")
