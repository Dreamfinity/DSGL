...
/**
 * Minecraft 1.12.2 host that owns UI lifecycle and boilerplate.
 *
...
abstract class DsglScreenHost(
    ...
    private lateinit var adapter: Mc1122UiAdapter
    ...
    override fun initGui() {
        DsglFonts.ensureInitialized(mc.gameDir, javaClass.classLoader)
        adapter = Mc1122UiAdapter(mc)
        ...
        StyleEngine.setStylesDirectory(File(mc.gameDir, "dsgl/styles"))
