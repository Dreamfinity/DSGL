...
private fun defaultDndItems(): List<DndDemoItem> = listOf(
    DndDemoItem(
        id = "apple",
        label = "Apple",
        stack = McItemStackRef(ItemStack(Items.APPLE))
    ),
    DndDemoItem(
        id = "bread",
        label = "Bread",
        stack = McItemStackRef(ItemStack(Items.BREAD))
    ),
    DndDemoItem(
        id = "carrot",
        label = "Carrot",
        stack = McItemStackRef(ItemStack(Items.CARROT))
    ),
    DndDemoItem(
        id = "diamond",
        label = "Diamond",
        stack = McItemStackRef(ItemStack(Items.DIAMOND))
    )
)
