package org.dreamfinity.dsgl.mcForge1122.demo
...
import org.dreamfinity.dsgl.mcForge1122.demo.sections.*
import org.dreamfinity.dsgl.mcForge1122.demo.support.*
...
class ShowcaseWindow : DsglWindow() {
    ...
    internal val blockItemRef = McItemStackRef(ItemStack(Item.getItemFromBlock(Blocks.STONE)))
    ...
    private fun prepareDemoMedia() {
        try {
            val dataDir = Minecraft.getMinecraft().gameDir
            writeDemoImage(
