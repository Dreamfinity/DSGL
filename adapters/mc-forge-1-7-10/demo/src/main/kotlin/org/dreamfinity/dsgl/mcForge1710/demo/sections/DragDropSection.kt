...
private data class DndSectionState(
    ...
    val boxes: Map<String, List<DndDemoItem>> =
        linkedMapOf(
            "box-a" to emptyList(),
            "box-b" to emptyList(),
            "box-c" to emptyList(),
...
fun UiScope.dragNDropSection(
    ...
    fun extractCard(
        ...
        val boxes =
            linkedMapOf<String, MutableList<DndDemoItem>>().apply {
    ...
    fun resolveLaneIntentFromMouse(laneNode: DOMNode?, mouseY: Int, excludedCardId: String?): LaneHoverIntent {
    ...
    fun laneCandidateCount(laneNode: DOMNode?, excludedCardId: String?): Int = laneCards(laneNode, excludedCardId).size
        ...
        div({
            ...
            div({
                ...
                style = {
                    ...
                    border {
                        width = 1.px
                        color = if (state.reorderHoverLaneAppend) 0xFF9EC4E3.toInt() else 0x44405058
                    }
                    display = Display.Flex
                    flexDirection = FlexDirection.Column
                }
    ...
    div({
        ...
        style = {
            ...
            when (insertionIndicator) {
                ...
                DndLaneIndicator.AFTER ->
                    margin {
                        top = 0.px
                        right = 0.px
                        bottom = insertionGap.px
                        left = 0.px
                    }
